setwd("/Users/chizhang/UNL/Tom Clemente/Carbon pathway/Soybean_count_table_and_summary")
set.seed(133)
library("DESeq2")

table_count <- read.table(file = "all_raw_table_WRI1_06292020.txt", header = TRUE, row.names=1)
table_cond <- read.csv(file = "sample_info.csv", header = TRUE, row.names=1)
